...
def main():
    ...
    if model.lora_type=="continuallora" or model.lora_type=="ortha" :
    ...
    if opt.delta_ckpt is not None:
        ...
        if opt.compress:
           ...
           m, u=model.load_state_dict(delta_st, strict=False)
                    ...
                    for n in trange(opt.n_iter, desc="Sampling"):
                        ...
                        if not opt.skip_save:
                            for x_sample in x_samples_ddim:
                                ...
                                print(os.path.join(sample_path, f"{base_count:05}.png"))
                                if opt.skip_grid:
                                    json_data = {f"{base_count:05}": prompts[0]}
                                    with open(f"{outpath}/{opt.concept}/prompts.json", "a") as json_file:
